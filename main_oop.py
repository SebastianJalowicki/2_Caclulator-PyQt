...
class CalcApp(QWidget):
    ...
    def __init__(self):
        ...
        self.text_box.setFont(QFont('Calibri', 22))
        ...
        self.clear.setStyleSheet('QPushButton { font: 14pt Calibri; padding: 10px }')
        self.delete.setStyleSheet('QPushButton { font: 14pt Calibri; padding: 10px }')
